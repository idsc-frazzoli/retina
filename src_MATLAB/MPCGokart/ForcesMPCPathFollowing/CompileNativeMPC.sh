...
gcc nativeexecutionLCM.c -o nativeMPCLCM MPCPathFollowing_casadi2forces.o MPCPathFollowing_model_1.o MPCPathFollowing_model_41.o MPCPathFollowing/obj/MPCPathFollowing.o -lm -llcm
