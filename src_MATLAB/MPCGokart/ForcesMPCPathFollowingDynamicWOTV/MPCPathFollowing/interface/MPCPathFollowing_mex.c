...
extern void MPCPathFollowing_casadi2forces(MPCPathFollowing_float *x, MPCPathFollowing_float *y, MPCPathFollowing_float *l, MPCPathFollowing_float *p, MPCPathFollowing_float *f, MPCPathFollowing_float *nabla_f, MPCPathFollowing_float *c, MPCPathFollowing_float *nabla_c, MPCPathFollowing_float *h, MPCPathFollowing_float *nabla_h, MPCPathFollowing_float *hess, solver_int32_default stage, solver_int32_default iteration);
...
void mexFunction( solver_int32_default nlhs, mxArray *plhs[], solver_int32_default nrhs, const mxArray *prhs[] )  
{
    ...
    if (nrhs != 1) 
	{
        mexErrMsgTxt("This function requires exactly 1 input: PARAMS struct.\nType 'help MPCPathFollowing_mex' for details.");
    }    
	if (nlhs > 3) 
	{
    ...
    if( mxGetM(par) != 434 || mxGetN(par) != 1 ) 
	{
    mexErrMsgTxt("PARAMS.x0 must be of size [434 x 1]");
    }
#endif	 
    copyMArrayToC_double(mxGetPr(par), params.x0,434);
    ...
    if( mxGetM(par) != 1054 || mxGetN(par) != 1 ) 
	{
    mexErrMsgTxt("PARAMS.all_parameters must be of size [1054 x 1]");
    }
#endif	 
    copyMArrayToC_double(mxGetPr(par), params.all_parameters,1054);
	...
	plhs[0] = mxCreateStructMatrix(1, 1, 1, outputnames);
		outvar = mxCreateDoubleMatrix(434, 1, mxREAL);
	copyCArrayToM_double( output.alldata, mxGetPr(outvar), 434);
