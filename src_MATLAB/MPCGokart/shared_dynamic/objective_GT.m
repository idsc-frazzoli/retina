function f = objective_GT(z,points,radii,vmax, maxxacc, steeringreg)
    global index
%[ab,dotbeta,ds, x,y,theta,v,beta,s,braketemp]
    ...
    f = lagcost+latcost*0.01+reg+prog+5*slack+500*slack2+speedcost+0.01*tv^2;%-0.01*sidewardsspeed^2;
end
