...
pointsO = 4;
pointsN = 10;
PosVehicle2=p(pointsO+pointsN*3+1:end);
...
distanceX=realPos(1)-PosVehicle2(1);
distanceY=realPos(2)-PosVehicle2(2);
...
v6 = squared_distance_array-0.7^2+0.5*slack2;
%v4 = error'*error;
%v2 = -1;
%v = [v1;v2;v3];
v = [v1;v2;v3;v4;v5;v6];
