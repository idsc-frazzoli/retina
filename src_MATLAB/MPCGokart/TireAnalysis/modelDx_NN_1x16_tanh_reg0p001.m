function [ACCX,ACCY,ACCROTZ] = modelDx_NN_1x16_tanh_reg0p001(VELX,VELY,VELROTZ,BETA,AB,TV, param)
    ...
    stds = [1.907241556285694 0.3079627568782051 0.5515613235298231 0.20101736434516326 0.8309067855283836 0.634574245360539];input = [VELX,VELY,VELROTZ,BETA,AB,TV];
