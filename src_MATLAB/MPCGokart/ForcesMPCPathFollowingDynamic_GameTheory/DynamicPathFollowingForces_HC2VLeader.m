...
% constraints on collisions. The second go-kart (leader) is not aware of 
% the first
...
%% CodeOptions for FORCES solver kart 1
...
%% CodeOptions for FORCES solver kart 2 (unaware of the other)
