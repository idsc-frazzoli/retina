...
/* package */ class ColoredLidarPointsRender implements LidarPointsRender, LidarRayBlockListener {
  ...
  public ColoredLidarPointsRender(Tensor model2pixel, int maxSize) {
