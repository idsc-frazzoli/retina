  ...
  public AutoboxCompactComponent() {
    ...
    if (Objects.nonNull(vmu931LcmServerModule)) {
      JToolBar jToolBar = createRow("vmu931 ctrl");
      {
        ...
        StaticHelper.actionListener(jButton, vmu931LcmServerModule::requestStatus);
        jToolBar.add(jButton);
      }
      {
        JButton jButton = new JButton("self-test");
        StaticHelper.actionListener(jButton, vmu931LcmServerModule::requestSelftest);
        jToolBar.add(jButton);
      }
      {
        JButton jButton = new JButton("calibration");
        StaticHelper.actionListener(jButton, vmu931LcmServerModule::requestCalibration);
        jToolBar.add(jButton);
      }
    }
