...
public enum MPCLudicDriverConfigs {
  BEGINNER(RealScalar.of(0.02), //Speed cost
  ...
  MODERATE(RealScalar.of(0.02), //Speed cost
      RealScalar.of(1),         //Lag Error
  ...
  ADVANCED(RealScalar.of(0.03), //Speed cost
      RealScalar.of(1),         //Lag Error
  ...
  MPCLudicDriverConfigs(Scalar speedcost, Scalar lagError, Scalar latError, Scalar progress, Scalar regularizerAB, //
      Scalar regularizerTV, Scalar slackSoftConstraint, Scalar maxSpeed) {
