...
public class GokartSoundLcmModule extends AbstractModule {
  private final List<SoundExciter> exciters = Arrays.asList( //
  ...
  // ---
  private final List<SoundResonator> resonators = Arrays.asList( //
  ...
  private final GokartSoundCreator gokartSoundCreator = new GokartSoundCreator(exciters, resonators, //
