...
/* package */ enum GokartLogCutter {
  ...
  public static void main(String[] args) throws IOException {
    File folder = new File("/home/mvb/0_ETH/01_MasterThesis/Logs_GoKart/LogData/dynamics_newFormat/RawData/test");
    ...
    for (File file : files) {
      ...
      new GokartLcmLogCutter( //
          ...
          new File("/home/mvb/0_ETH/01_MasterThesis/Logs_GoKart/LogData/dynamics_newFormat/test"), //
