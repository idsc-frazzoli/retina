...
enum SystemAnalysis {
  ...
  public static void main(String[] args) throws FileNotFoundException, IOException {
    ...
    Scalar scalar = Quantity.of(0, SI.SECOND);
    ...
    VelodyneLocalizationTable velodyneLocalizationTable = new VelodyneLocalizationTable(scalar);
    ...
    for (String filename: filenames) {
      ...
      OfflineLogPlayer.process(UserHome.file(filename),  velodyneLocalizationTable);
    }
    ...
    Export.of(UserHome.file("vlocalization.csv"), velodyneLocalizationTable.getTable().map(CsvFormat.strict()));
