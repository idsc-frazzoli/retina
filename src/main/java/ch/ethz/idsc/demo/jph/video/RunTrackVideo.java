...
/* package */ enum RunTrackVideo {
  ...
  public static void main(String[] args) throws Exception {
    ...
    final String imageName = "20191104_01";
    ...
    final File file = new File("/media/datahaki/data/gokart/visualize/20191104T105613_01", "log.lcm");
    ...
    // trackVideoConfig.frameLimit = 300;
