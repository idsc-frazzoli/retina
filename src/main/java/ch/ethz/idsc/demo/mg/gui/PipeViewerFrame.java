...
public class PipeViewerFrame implements TimedImageListener {
...
//      });
  ...
  public PipeViewerFrame(DavisDevice davisDevice, AbstractAccumulatedImage abstractAccumulatedImage) {
    ...
    JPanel jPanel = (JPanel) component;
    {
      ...
      // try {
      // ImageIO.write(pipeViewerComponent.sigImage, "png", UserHome.Pictures("sigImage.png"));
...
//      }
    ...
    jPanel.add(pipeViewerComponent.jComponent, BorderLayout.CENTER);
    ...
    // jFrame.setVisible(true);
    {
      TimerTask timerTask = new TimerTask() {
        @Override
        public void run() {
          pipeViewerComponent.jComponent.repaint();
        }
      };
      timer.schedule(timerTask, 100, 33); // 33 ms -> 30 Hz
    }
    // important that viewer component listens to the accumulated image
    abstractAccumulatedImage.addListener(pipeViewerComponent.timedImageListener);
