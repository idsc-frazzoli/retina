...
public class SlamConfig {
  ...
  // update rates
  public final Scalar resampleRate = RealScalar.of(0.01); // [s]
  public final Scalar statePropagationRate = RealScalar.of(0.001); // [s]
  ...
  // particle roughening
  public final Scalar rougheningLinVelStd = RealScalar.of(0.3); // [m/s]
  public final Scalar rougheningAngVelStd = RealScalar.of(0.1); // [rad/s]
  // SLAM map parameters
