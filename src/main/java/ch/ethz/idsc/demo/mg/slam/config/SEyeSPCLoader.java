...
/* package */ enum SEyeSPCLoader {
  ...
  public static SlamPrcConfig getSlamPrcConfig() {
    ...
    slamPrcConfig.visibleBoxXMax = Quantity.of(8, SI.METER); // [m] in go kart frame
    /** half 'width' of rectangle for RegionOfInterestFilter */
    slamPrcConfig.visibleBoxYHalfWidth = Quantity.of(1.5, SI.METER); // [m] in go kart frame
    // MergeWaypointFilter
