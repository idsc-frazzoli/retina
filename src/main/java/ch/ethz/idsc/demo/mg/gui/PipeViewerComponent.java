...
public class PipeViewerComponent implements DavisImuFrameListener {
  ...
  final JComponent jComponent = new JComponent() {
    ...
    protected void paintComponent(Graphics graphics) {
      ...
      if (imageCopy.hasValue())
        // this draws the event based image
        graphics.drawImage(imageCopy.get(), 1 * 240, offsetY, null);
      // TODO maybe here print the filtered event stream?
      graphics.drawImage(imageCopy.get(), 1 * 240, offsetY + 200, null);
