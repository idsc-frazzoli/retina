...
/* package */ enum DavisSCCLoader {
  ...
  public static SlamCoreConfig getSlamCoreConfig() {
    ...
    slamCoreConfig.slamAlgoConfig = SlamAlgoConfig.lidarMode;
    ...
    slamCoreConfig.lookAheadDistance = Quantity.of(5, SI.METER);
    /** for reactive mapping modes */
    slamCoreConfig.lookBehindDistance = Quantity.of(-3, SI.METER);
    ...
    slamCoreConfig.logCollectionUpdateRate = Quantity.of(0.001, SI.SECOND);
