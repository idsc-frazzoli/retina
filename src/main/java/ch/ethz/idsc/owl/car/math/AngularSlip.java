...
public enum AngularSlip {
   ...
   * @return */
  public static Scalar rotationPerMeterDriven(Scalar theta, Scalar xAxleRtoF) {
   ...
   * @return */
  public static Scalar of(Scalar theta, Scalar xAxleRtoF, Scalar tangentSpeed, Scalar gyroZ) {
    // theta has interpretation in rad/m but is encoded in true SI units: "m^-1"
    Scalar rotationPerMeterDriven = rotationPerMeterDriven(theta, xAxleRtoF);
