...
public class DvsStandaloneClient {
  ...
  public DvsStandaloneClient(DavisDecoder davisDecoder) {
  ...
  // @Override
  public void start() {
    try (DatagramSocket datagramSocket = new DatagramSocket(DvsStandaloneServer.PORT)) {
