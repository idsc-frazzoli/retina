...
public class ApsStandaloneClient {
  ...
  public ApsStandaloneClient(DavisDecoder davisDecoder) {
  ...
  // @Override
  public void start() {
    try (DatagramSocket datagramSocket = new DatagramSocket(ApsStandaloneServer.PORT)) {
