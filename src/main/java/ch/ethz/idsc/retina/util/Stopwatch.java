...
public class Stopwatch {
  ...
  /** @return new instance of {@code Stopwatch} that is in the stopped state with
   * display reading 0:00:00 */
  ...
  /** constructor creates an instance that is not started, i.e. the display is
   * frozen at 0:00:00. */
  private Stopwatch() {
  }
  ...
  // function is private because state of stopwatch can be tracked in the
  // application layer
