...
public final class Hdl32eFiringPacketConsumerImpl implements Hdl32eFiringPacketConsumer {
  private List<FiringPacketInterface> firingPacketInterfaces = new LinkedList<>();
