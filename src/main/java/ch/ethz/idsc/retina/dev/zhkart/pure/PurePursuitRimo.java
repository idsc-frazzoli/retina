...
import ch.ethz.idsc.retina.dev.rimo.RimoRateControllerWrap_2;
...
class PurePursuitRimo extends PurePursuitBase implements RimoPutProvider {
  ...
  final RimoRateControllerWrap_2 rimoRateControllerWrap_2 = new RimoRateControllerWrap_2();
  private final boolean useDiffSpeed = false;
  ...
  /* package */ Optional<RimoPutEvent> control(SteerColumnInterface steerColumnInterface) {
    if (steerColumnInterface.isSteerColumnCalibrated()) {
      ...
      if (useDiffSpeed == true) {
        // TODO either kill this completely or make a way to change control mode through the interface
        ...
        return rimoRateControllerWrap_2.iterate(speed);
      }
    }
    return Optional.empty();
  }
