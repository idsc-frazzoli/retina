...
public class PcalHdl32ePositionProvider implements Hdl32ePositionProvider {
  private final Hdl32ePositionListener hdl32ePositionListener;
  private final File file;

  public PcalHdl32ePositionProvider(Hdl32ePositionListener hdl32ePositionListener, //
      File file) {
    ...
    Runnable runnable = new Runnable() {
      ...
      public void run() {
        PacketConsumer packetConsumer = new Hdl32ePacketConsumer( //
            new Hdl32eFiringCollector(hdl32ePositionListener));
        try {
