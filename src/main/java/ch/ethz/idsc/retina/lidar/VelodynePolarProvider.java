...
public abstract class VelodynePolarProvider implements LidarRayDataListener {
  ...
  // ---
  protected final List<LidarPolarListener> listeners = new LinkedList<>();
  protected int usec;
  ...
  public final void addListener(LidarPolarListener lidarPolarListener) {
    listeners.add(lidarPolarListener);
  }
