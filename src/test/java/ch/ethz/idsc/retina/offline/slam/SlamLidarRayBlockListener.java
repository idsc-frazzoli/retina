...
public class SlamLidarRayBlockListener extends OfflineLocalize {
  private static final Tensor LIDAR = Se2Utils.toSE2Matrix(SensorsConfig.GLOBAL.vlp16).unmodifiable();
  ...
  public SlamLidarRayBlockListener(Tensor model2pixel) {
    this.model = model2pixel;
