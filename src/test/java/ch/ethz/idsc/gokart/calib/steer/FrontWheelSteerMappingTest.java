...
public class FrontWheelSteerMappingTest extends TestCase {
  public void testSimple() {
    Scalar scalar = FrontWheelSteerMapping._LEFT.getAngleFromSCE(Quantity.of(0.0, "SCE"));
    assertEquals(scalar, RealScalar.ZERO);
  }

  public void testP06() {
    Scalar scalar = FrontWheelSteerMapping._LEFT.getAngleFromSCE(Quantity.of(0.6, "SCE"));
  ...
  public void testSymmetry() {
    for (Tensor _x : Subdivide.of(-1, 1, 20)) {
      Scalar x = _x.Get();
      Scalar l = FrontWheelSteerMapping._LEFT.getAngleFromSCE(Quantity.of(x, "SCE"));
      Scalar r = FrontWheelSteerMapping.RIGHT.getAngleFromSCE(Quantity.of(x.negate(), "SCE"));
