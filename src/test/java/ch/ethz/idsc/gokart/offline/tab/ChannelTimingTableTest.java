...
public class ChannelTimingTableTest extends TestCase {
  public void testSimple() throws IOException {
    GokartLogInterface gokartLogInterface = GokartLogAdapterTest.FULL;
    // ---
    OfflineTableSupplier offlineTableSupplier = new ChannelTimingTable();
    ...
    assertEquals(Dimensions.of(tensor), Arrays.asList(15, 6));
  }
}
