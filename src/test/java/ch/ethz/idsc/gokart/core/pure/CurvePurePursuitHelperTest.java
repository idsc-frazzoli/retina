...
public class CurvePurePursuitHelperTest extends TestCase {
  public void testSpecific1() throws Exception {
    ...
    Optional<Scalar> optional = CurvePurePursuitHelper.getRatio(pose, DubendorfCurve.OVAL, true, PurePursuitConfig.GLOBAL.lookAhead);
  ...
  public void testSpecificHLE() throws Exception {
    ...
    Optional<Scalar> optional = CurvePurePursuitHelper.getRatio(pose, DubendorfCurve.HYPERLOOP_EIGHT, true, PurePursuitConfig.GLOBAL.lookAhead);
    Scalar lookAhead = optional.get();
  ...
  public void testSpecificHLE_R() throws Exception {
    Tensor pose = Tensors.fromString("{50.0[m], 48.6[m], 0.0}");
    Optional<Scalar> optional = CurvePurePursuitHelper.getRatio(pose, DubendorfCurve.HYPERLOOP_EIGHT, false, PurePursuitConfig.GLOBAL.lookAhead);
    Scalar lookAhead = optional.get();
  ...
  public void testSpecificHLER() throws Exception {
    ...
    Optional<Scalar> optional = CurvePurePursuitHelper.getRatio(pose, DubendorfCurve.HYPERLOOP_EIGHT_REVERSE, true, PurePursuitConfig.GLOBAL.lookAhead);
    Scalar lookAhead = optional.get();
  ...
  public void testSpecificHLER_R() throws Exception {
    Tensor pose = Tensors.fromString("{50.0[m], 48.6[m], 3.1415926535897932385}");
    Optional<Scalar> optional = CurvePurePursuitHelper.getRatio(pose, DubendorfCurve.HYPERLOOP_EIGHT_REVERSE, false, PurePursuitConfig.GLOBAL.lookAhead);
    Scalar lookAhead = optional.get();
